...
import { updateBaseSalary } from "@/lib/baseSalary/updatebaseSalary"
...
export default function UpdateDataBaseSalary({onClose,salary, position}: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await updateBaseSalary(SalaryData); // Gửi dữ liệu nhân sự và ảnh CMND
