  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 z-99 w-full h-full flex justify-center items-center addPerson">
        ...
        <div className="fixed z-999 min-w-[400px]">
            <Card>
            <CardHeader>
                <CardTitle className="uppercase drop-shadow-md text-[16px]">Thêm hình thức thanh toán</CardTitle>
            </CardHeader>
            <CardContent className="grid gap-6">
                <div className="grid gap-2">
                    <Label htmlFor="name">Hình thức thanh toán</Label>
                    <Input id="name" placeholder="Nhập Hình thức thanh toán mới..." value={name} onChange={(e) => setName(e.target.value)}/>
                </div>
            </CardContent>
